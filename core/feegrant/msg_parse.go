...
func parseFeeGrantArgs(feeGrantMsg types.FeeGrantMsg, granter sdk.AccAddress) (feegrant.MsgGrantAllowance, error) {
	if feeGrantMsg.Granter != granter.String() {
		return feegrant.MsgGrantAllowance{}, types.ErrWrap(types.ErrAccountNotMatch, "Account address generated by private key is not equal input granter of msg")
	}

	grantee, err := sdk.AccAddressFromBech32(feeGrantMsg.Grantee)
	if err != nil {
		return feegrant.MsgGrantAllowance{}, types.ErrWrap(types.ErrParse, err)
	}
	...
	if err != nil {
		return feegrant.MsgGrantAllowance{}, types.ErrWrap(types.ErrConvert, err)
	}
	...
	if periodClock > 0 || feeGrantMsg.PeriodLimit != "" {
		...
		if periodClock <= 0 {
			return feegrant.MsgGrantAllowance{}, types.ErrWrap(types.ErrInsufficientParams, "period clock was not set")
		}

		if periodLimit == nil {
			return feegrant.MsgGrantAllowance{}, types.ErrWrap(types.ErrInsufficientParams, "period limit was not set")
		}

		periodReset := getPeriodReset(periodClock)
		if feeGrantMsg.Expiration != "" && periodReset.Sub(expireTime) > 0 {
			return feegrant.MsgGrantAllowance{}, types.ErrWrap(types.ErrInvalidRequest, "period (", periodClock, ") cannot reset after expiration (", feeGrantMsg.Expiration, ")")
		}
...
func parseRevokeFeeGrantArgs(revokeFeeGrantMsg types.RevokeFeeGrantMsg, granter sdk.AccAddress) (feegrant.MsgRevokeAllowance, error) {
	if revokeFeeGrantMsg.Granter != granter.String() {
		return feegrant.MsgRevokeAllowance{}, types.ErrWrap(types.ErrAccountNotMatch, "Account address generated by private key is not equal input granter of msg")
	}
	grantee, err := sdk.AccAddressFromBech32(revokeFeeGrantMsg.Grantee)
	if err != nil {
		return feegrant.MsgRevokeAllowance{}, types.ErrWrap(types.ErrParse, err)
	}
...
func parseQueryFeeGrantArgs(queryGrantMsg types.QueryFeeGrantMsg) (feegrant.QueryAllowanceRequest, error) {
	...
	if err != nil {
		return feegrant.QueryAllowanceRequest{}, types.ErrWrap(types.ErrParse, err)
	}
...
func parseQueryFeeGrantsByGranteeArgs(queryGrantMsg types.QueryFeeGrantMsg) (feegrant.QueryAllowancesRequest, error) {
	grantee, err := sdk.AccAddressFromBech32(queryGrantMsg.Grantee)
	if err != nil {
		return feegrant.QueryAllowancesRequest{}, types.ErrWrap(types.ErrParse, err)
	}
...
func parseQueryFeeGrantsByGranterArgs(queryGrantMsg types.QueryFeeGrantMsg) (feegrant.QueryAllowancesByGranterRequest, error) {
	granter, err := sdk.AccAddressFromBech32(queryGrantMsg.Granter)
	if err != nil {
		return feegrant.QueryAllowancesByGranterRequest{}, types.ErrWrap(types.ErrParse, err)
	}
