...
func parseAuthzGrantArgs(authzGrantMsg types.AuthzGrantMsg, granter sdk.AccAddress) (authz.MsgGrant, error) {
	if authzGrantMsg.Granter != granter.String() {
		return authz.MsgGrant{}, types.ErrWrap(types.ErrAccountNotMatch, "Account address generated by private key is not equal input granter of msg")
	}
	grantee, err := sdk.AccAddressFromBech32(authzGrantMsg.Grantee)
	if err != nil {
		return authz.MsgGrant{}, types.ErrWrap(types.ErrParse)
	}
	expI64, err := util.FromStringToInt64(authzGrantMsg.Expiration)
	if err != nil {
		return authz.MsgGrant{}, types.ErrWrap(types.ErrConvert, err)
	}
	...
	case "send":
		...
		if limit == "" {
			return authz.MsgGrant{}, types.ErrWrap(types.ErrInsufficientParams, "require bank spend limit")
		}
		spendLimit, err := sdk.ParseCoinsNormalized(util.DenomAdd(limit))
		if err != nil {
			return authz.MsgGrant{}, types.ErrWrap(types.ErrParse, err)
		}
		if !spendLimit.IsAllPositive() {
			return authz.MsgGrant{}, types.ErrWrap(types.ErrInvalidRequest, "spend-limit should be greater than zero")
		}
	...
	case "delegate", "unbond", "redelegate":
		limit := authzGrantMsg.SpendLimit
		if limit == "" {
			return authz.MsgGrant{}, types.ErrWrap(types.ErrInsufficientParams, "require spend limit")
		}
	...
	default:
		return authz.MsgGrant{}, types.ErrWrap(types.ErrInvalidMsgType, "invalid authorization type, ", authzGrantMsg.AuthorizationType)
	}
...
func parseAuthzRevokeArgs(authzRevokeMsg types.AuthzRevokeMsg, granter sdk.AccAddress) (authz.MsgRevoke, error) {
	if authzRevokeMsg.Granter != granter.String() {
		return authz.MsgRevoke{}, types.ErrWrap(types.ErrAccountNotMatch, "Account address generated by private key is not equal input granter of msg")
	}
	grantee, err := sdk.AccAddressFromBech32(authzRevokeMsg.Grantee)
	if err != nil {
		return authz.MsgRevoke{}, types.ErrWrap(types.ErrParse, err)
	}
...
func parseAuthzExecArgs(authzExecMsg types.AuthzExecMsg, encodingConfig params.EncodingConfig) (authz.MsgExec, error) {
	...
	if err != nil {
		return authz.MsgExec{}, types.ErrWrap(types.ErrParse, err)
	}
	...
	if authzExecMsg.ExecFile != "" {
		...
		if err != nil {
			return authz.MsgExec{}, types.ErrWrap(types.ErrCannotRead, err)
		}
		...
		return authz.MsgExec{}, types.ErrWrap(types.ErrInsufficientParams, "no authz exec info")
	}
...
func parseQueryAuthzGrantsArgs(queryAuthzGrantMsg types.QueryAuthzGrantMsg) (authz.QueryGrantsRequest, error) {
	...
	if err != nil {
		return authz.QueryGrantsRequest{}, types.ErrWrap(types.ErrParse, err)
	}
	if queryAuthzGrantMsg.Granter != granter.String() {
		return authz.QueryGrantsRequest{}, types.ErrWrap(types.ErrAccountNotMatch, "Account address generated by private key is not equal input granter of msg")
	}
...
func parseQueryAuthzGrantsByGranteeArgs(queryAuthzGrantMsg types.QueryAuthzGrantMsg) (authz.QueryGranteeGrantsRequest, error) {
	grantee, err := sdk.AccAddressFromBech32(queryAuthzGrantMsg.Grantee)
	if err != nil {
		return authz.QueryGranteeGrantsRequest{}, types.ErrWrap(types.ErrParse, err)
	}
...
func parseQueryAuthzGrantsByGranterArgs(queryAuthzGrantMsg types.QueryAuthzGrantMsg) (authz.QueryGranterGrantsRequest, error) {
	granter, err := sdk.AccAddressFromBech32(queryAuthzGrantMsg.Granter)
	if err != nil {
		return authz.QueryGranterGrantsRequest{}, types.ErrWrap(types.ErrParse, err)
	}
